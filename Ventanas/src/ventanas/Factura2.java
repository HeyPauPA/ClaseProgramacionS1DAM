...
public class Factura2 extends JFrame {
	...
	private void actualizar() {
		//obtener el valor de iva
		int iva = 0;
		String textoSeleccionado = "";
	    //hablar con la caja de seleccion para sabaer cual esta selecccionado
		
		textoSeleccionado = (String)comboBox.getSelectedItem();
